...
call javaapi#class('GenericURLContext', 'Context', [
  \ javaapi#method(0,'GenericURLContext(', 'Hashtable)', 'public'),
...
call javaapi#class('Uri', '', [
  \ javaapi#method(0,'Uri(', 'String) throws MalformedURLException', 'public'),
...
call javaapi#class('UrlUtil', '', [
  \ javaapi#method(1,'decode(', 'String) throws MalformedURLException', 'String'),
  \ javaapi#method(1,'decode(', 'String, String) throws MalformedURLException, UnsupportedEncodingException', 'String'),
