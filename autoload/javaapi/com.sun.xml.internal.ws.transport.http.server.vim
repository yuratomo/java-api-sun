...
call javaapi#class('InvokerImpl', '', [
...
call javaapi#class('EndpointImpl', '', [
...
call javaapi#class('PortableConnectionImpl', '', [
...
call javaapi#class('PortableHttpHandler', '', [
...
call javaapi#class('ServerAdapter', '', [
...
call javaapi#class('ServerAdapterList', '', [
...
call javaapi#class('LWHSInputStream', '', [
  \ javaapi#method(0,'close(', ') throws IOException', 'void'),
  \ ])

call javaapi#class('ServerConnectionImpl', '', [
...
call javaapi#class('ServerContainer', '', [
