...
call javaapi#class('BIWindowPainter', 'TranslucentWindowPainter', [
  \ javaapi#method(0,'flush(', ')', 'void'),
  \ ])

call javaapi#class('VIOptD3DWindowPainter', 'VIOptWindowPainter', [
  \ ])

call javaapi#class('VIOptWGLWindowPainter', 'VIOptWindowPainter', [
  \ ])
...
call javaapi#class('VIOptWindowPainter', 'VIWindowPainter', [
  \ ])

call javaapi#class('VIWindowPainter', 'BIWindowPainter', [
  \ javaapi#method(0,'flush(', ')', 'void'),
  \ ])
...
call javaapi#class('Encoder', 'Encoder', [
...
call javaapi#class('PrintToFileErrorDialog', 'Dialog', [
...
call javaapi#class('ScrollEvent', 'PeerEvent', [
