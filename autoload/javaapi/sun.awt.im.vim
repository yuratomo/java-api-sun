...
call javaapi#class('ExecutableInputMethodManager', '', [
...
call javaapi#class('InputMethodContext', '', [
...
call javaapi#class('AWTInputMethodPopupMenu', '', [
  \ ])

call javaapi#class('FrameWindowAdapter', '', [
  \ javaapi#method(0,'windowActivated(', 'WindowEvent)', 'void'),
  \ ])

call javaapi#class('CompositionArea', '', [
...
call javaapi#class('InputMethodJFrame', '', [
...
call javaapi#class('JInputMethodPopupMenu', '', [
  \ ])

call javaapi#class('SimpleInputMethodWindow', '', [
