...
call javaapi#class('AbstractNotificationHandler', 'NotificationHandler', [
...
call javaapi#class('HandlerResult', 'Enum', [
...
call javaapi#interface('NotificationHandler', '', [
  \ javaapi#method(0,1,'handleNotification(', 'Notification, T)', 'HandlerResult'),
  \ ])
...
call javaapi#class('SctpMultiChannel', 'AbstractSelectableChannel', [
  ...
  \ javaapi#method(0,1,'associations(', ') throws IOException', 'Set'),
...
call javaapi#interface('SctpSocketOption', 'SocketOption', [
  \ ])

call javaapi#class('SctpStandardSocketOptions', '', [
  \ javaapi#field(1,1,'SCTP_DISABLE_FRAGMENTS', 'SctpSocketOption'),
  \ javaapi#field(1,1,'SCTP_EXPLICIT_COMPLETE', 'SctpSocketOption'),
  \ javaapi#field(1,1,'SCTP_FRAGMENT_INTERLEAVE', 'SctpSocketOption'),
  \ javaapi#field(1,1,'SCTP_INIT_MAXSTREAMS', 'SctpSocketOption'),
  \ javaapi#field(1,1,'SCTP_NODELAY', 'SctpSocketOption'),
  \ javaapi#field(1,1,'SCTP_PRIMARY_ADDR', 'SctpSocketOption'),
  \ javaapi#field(1,1,'SCTP_SET_PEER_PRIMARY_ADDR', 'SctpSocketOption'),
  \ javaapi#field(1,1,'SO_SNDBUF', 'SctpSocketOption'),
  \ javaapi#field(1,1,'SO_RCVBUF', 'SctpSocketOption'),
  \ javaapi#field(1,1,'SO_LINGER', 'SctpSocketOption'),
  \ ])
