...
call javaapi#class('ExtendedCopyOption', 'Enum', [
...
call javaapi#class('ExtendedOpenOption', 'Enum', [
...
call javaapi#class('ExtendedWatchEventModifier', 'Enum', [
...
call javaapi#class('SensitivityWatchEventModifier', 'Enum', [
