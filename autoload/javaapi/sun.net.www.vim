...
call javaapi#class('MimeTable', 'FileNameMap', [
  ...
  \ javaapi#method(0,1,'elements(', ')', 'MimeEntry>'),
...
call javaapi#class('MessageHeader', '', [
  ...
  \ javaapi#method(0,1,'multiValueIterator(', 'String)', 'String>'),
  \ javaapi#method(0,1,'getHeaders(', ')', 'String>>'),
  \ javaapi#method(0,1,'getHeaders(', 'String[])', 'String>>'),
  \ javaapi#method(0,1,'filterAndAddHeaders(', 'String[], Map<String, List<String>>)', 'String>>'),
