...
call javaapi#class('BufferedDrawHandler', 'DrawHandler', [
...
call javaapi#class('ImmutableRegion', 'Region', [
...
call javaapi#class('Tracer', 'RenderingEngine', [
...
call javaapi#class('Simple', 'SpanShapeRenderer', [
...
call javaapi#class('Composite', 'SpanShapeRenderer', [
