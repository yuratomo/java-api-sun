...
call javaapi#interface('ArrayInfo', 'NonElement', [
  \ javaapi#method(0,1,'getItemType(', ')', 'C>'),
  \ ])

call javaapi#interface('AttributePropertyInfo', 'NonElementRef<T,C>', [
...
call javaapi#interface('BuiltinLeafInfo', 'LeafInfo', [
  \ javaapi#method(0,1,'getTypeName(', ')', 'QName'),
  \ ])

call javaapi#interface('ClassInfo', 'MaybeElement', [
...
call javaapi#interface('ElementPropertyInfo', 'PropertyInfo', [
...
call javaapi#interface('EnumConstant', '', [
  \ javaapi#method(0,1,'getEnclosingClass(', ')', 'C>'),
  \ javaapi#method(0,1,'getLexicalValue(', ')', 'String'),
  \ javaapi#method(0,1,'getName(', ')', 'String'),
  \ ])

call javaapi#interface('EnumLeafInfo', 'LeafInfo', [
  \ javaapi#method(0,1,'getClazz(', ')', 'C'),
...
call javaapi#interface('LeafInfo', 'MaybeElement', [
  \ ])

call javaapi#interface('MapPropertyInfo', 'PropertyInfo', [
  \ javaapi#method(0,1,'getXmlName(', ')', 'QName'),
  \ javaapi#method(0,1,'isCollectionNillable(', ')', 'boolean'),
...
call javaapi#interface('MaybeElement', 'NonElement', [
  \ javaapi#method(0,1,'isElement(', ')', 'boolean'),
  \ javaapi#method(0,1,'getElementName(', ')', 'QName'),
  \ javaapi#method(0,1,'asElement(', ')', 'C>'),
  \ ])

call javaapi#interface('NonElement', 'TypeInfo', [
  \ javaapi#field(1,1,'ANYTYPE_NAME', 'QName'),
  \ javaapi#method(0,1,'getTypeName(', ')', 'QName'),
  \ javaapi#method(0,1,'isSimpleType(', ')', 'boolean'),
  \ ])

call javaapi#interface('NonElementRef', '', [
  \ javaapi#method(0,1,'getTarget(', ')', 'C>'),
  \ javaapi#method(0,1,'getSource(', ')', 'C>'),
  \ ])

call javaapi#interface('PropertyInfo', 'AnnotationSource', [
...
call javaapi#class('PropertyKind', 'Enum', [
...
call javaapi#interface('ReferencePropertyInfo', 'PropertyInfo', [
...
call javaapi#interface('RegistryInfo', '', [
  \ javaapi#method(0,1,'getReferences(', ')', 'C>>'),
  \ javaapi#method(0,1,'getClazz(', ')', 'C'),
  \ ])

call javaapi#interface('TypeInfo', 'Locatable', [
  \ javaapi#method(0,1,'getType(', ')', 'T'),
  \ javaapi#method(0,1,'canBeReferencedByIDREF(', ')', 'boolean'),
  \ ])

call javaapi#interface('TypeInfoSet', '', [
...
call javaapi#interface('TypeRef', 'NonElementRef', [
  \ javaapi#method(0,1,'getTagName(', ')', 'QName'),
  \ javaapi#method(0,1,'isNillable(', ')', 'boolean'),
  \ javaapi#method(0,1,'getDefaultValue(', ')', 'String'),
  \ ])

call javaapi#interface('ValuePropertyInfo', 'NonElementRef<T,C>', [
  \ javaapi#method(0,1,'getAdapter(', ')', 'C>'),
  \ ])

call javaapi#class('WildcardMode', 'Enum', [
...
call javaapi#interface('WildcardTypeInfo', 'TypeInfo', [
  \ ])
