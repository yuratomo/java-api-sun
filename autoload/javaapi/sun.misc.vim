...
call javaapi#class('Daemon', 'Thread', [
  \ javaapi#method(0,'run(', ')', 'void'),
...
call javaapi#class('IndirectEntry', 'Entry', [
...
call javaapi#class('ValueEntry', 'Entry', [
...
call javaapi#class('EntrySet', 'AbstractSet', [
...
call javaapi#class('ValueCell', 'SoftReference', [
  \ ])
...
call javaapi#class('FileLoader', 'Loader', [
  \ ])
...
call javaapi#class('JarLoader', 'Loader', [
  \ javaapi#method(0,'close(', ') throws IOException', 'void'),
  \ ])
...
call javaapi#class('AppClassLoader', 'URLClassLoader', [
...
call javaapi#class('ExtClassLoader', 'URLClassLoader', [
