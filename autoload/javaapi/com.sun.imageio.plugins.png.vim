...
call javaapi#class('PNGImageReader', 'ImageReader', [
  ...
  \ javaapi#method(0,1,'getImageTypes(', 'int) throws IIOException', 'ImageTypeSpecifier>'),
...
call javaapi#class('PNGMetadata', 'IIOMetadata', [
  ...
  \ javaapi#field(0,1,'iTXt_keyword', 'String>'),
  \ javaapi#field(0,1,'iTXt_compressionFlag', 'Boolean>'),
  \ javaapi#field(0,1,'iTXt_compressionMethod', 'Integer>'),
  \ javaapi#field(0,1,'iTXt_languageTag', 'String>'),
  \ javaapi#field(0,1,'iTXt_translatedKeyword', 'String>'),
  \ javaapi#field(0,1,'iTXt_text', 'String>'),
  ...
  \ javaapi#field(0,1,'tEXt_keyword', 'String>'),
  \ javaapi#field(0,1,'tEXt_text', 'String>'),
  ...
  \ javaapi#field(0,1,'zTXt_keyword', 'String>'),
  \ javaapi#field(0,1,'zTXt_compressionMethod', 'Integer>'),
  \ javaapi#field(0,1,'zTXt_text', 'String>'),
  \ javaapi#field(0,1,'unknownChunkType', 'String>'),
  \ javaapi#field(0,1,'unknownChunkData', 'ArrayList<byte[]>'),
