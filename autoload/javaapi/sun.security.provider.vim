...
call javaapi#class('CaseExactJKS', 'JavaKeyStore', [
...
call javaapi#class('JKS', 'JavaKeyStore', [
...
call javaapi#class('SelfPermission', 'Permission', [
...
call javaapi#class('SHA384', 'SHA5', [
  \ javaapi#method(0,'SHA384(', ')', 'public'),
  \ javaapi#method(0,'clone(', ')', 'Object'),
  \ ])

call javaapi#class('SHA512', 'SHA5', [
...
call javaapi#class('ThreadedSeedGenerator', 'SeedGenerator', [
  \ javaapi#method(0,'run(', ')', 'void'),
  \ ])
...
call javaapi#class('URLSeedGenerator', 'SeedGenerator', [
  \ ])
...
call javaapi#class('SHA1withDSA', 'DSA', [
