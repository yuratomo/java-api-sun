...
call javaapi#class('AppletSecurity', '', [
...
call javaapi#class('AppletViewer', '', [
...
call javaapi#class('AppletPanel', '', [
...
call javaapi#class('AppletViewerPanel', '', [
...
call javaapi#class('AppContextCreator', '', [
  \ javaapi#method(0,'run(', ')', 'void'),
  \ ])

call javaapi#class('AppletThreadGroup', '', [
  \ javaapi#method(0,'AppletThreadGroup(', 'String)', 'public'),
  \ javaapi#method(0,'AppletThreadGroup(', 'ThreadGroup, String)', 'public'),
  \ ])

call javaapi#class('AppletClassLoader', '', [
...
call javaapi#interface('AppletListener', '', [
  \ javaapi#method(0,'appletStateChanged(', 'AppletEvent)', 'void'),
  \ ])
...
call javaapi#class('AppletEvent', '', [
...
call javaapi#class('AppletIOException', '', [
...
call javaapi#class('AppletIllegalArgumentException', '', [
  \ javaapi#method(0,'AppletIllegalArgumentException(', 'String)', 'public'),
  \ javaapi#method(0,'getLocalizedMessage(', ')', 'String'),
  \ ])

call javaapi#class('AppletImageRef', '', [
  \ javaapi#method(0,'flush(', ')', 'void'),
  \ javaapi#method(0,'reconstitute(', ')', 'Object'),
  \ ])

call javaapi#class('AppletObjectInputStream', '', [
...
call javaapi#class('AppletProps', '', [
  \ javaapi#method(0,'action(', 'Event, Object)', 'boolean'),
  \ ])

call javaapi#class('AppletPropsErrorDialog', '', [
...
call javaapi#class('AppletSecurityException', '', [
