...
call javaapi#class('ResourceBundleEnumeration', 'Enumeration', [
...
call javaapi#class('CoreResourceBundleControl', 'Control', [
  ...
  \ javaapi#method(0,1,'getCandidateLocales(', 'String, Locale)', 'List'),
  \ javaapi#method(0,1,'getTimeToLive(', 'String, Locale)', 'long'),
  \ ])

call javaapi#namespace('sun.util')

call javaapi#class('PreHashedMap', 'AbstractMap', [
