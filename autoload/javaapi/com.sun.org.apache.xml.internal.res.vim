...
call javaapi#class('XMLErrorResources', 'ListResourceBundle', [
  \ javaapi#field(1,1,'MAX_CODE', 'int'),
  \ javaapi#field(1,1,'MAX_WARNING', 'int'),
  \ javaapi#field(1,1,'MAX_OTHERS', 'int'),
  \ javaapi#field(1,1,'MAX_MESSAGES', 'int'),
  \ javaapi#field(1,1,'ER_FUNCTION_NOT_SUPPORTED', 'String'),
  \ javaapi#field(1,1,'ER_CANNOT_OVERWRITE_CAUSE', 'String'),
  \ javaapi#field(1,1,'ER_NO_DEFAULT_IMPL', 'String'),
  \ javaapi#field(1,1,'ER_CHUNKEDINTARRAY_NOT_SUPPORTED', 'String'),
  \ javaapi#field(1,1,'ER_OFFSET_BIGGER_THAN_SLOT', 'String'),
  \ javaapi#field(1,1,'ER_COROUTINE_NOT_AVAIL', 'String'),
  \ javaapi#field(1,1,'ER_COROUTINE_CO_EXIT', 'String'),
  \ javaapi#field(1,1,'ER_COJOINROUTINESET_FAILED', 'String'),
  \ javaapi#field(1,1,'ER_COROUTINE_PARAM', 'String'),
  \ javaapi#field(1,1,'ER_PARSER_DOTERMINATE_ANSWERS', 'String'),
  \ javaapi#field(1,1,'ER_NO_PARSE_CALL_WHILE_PARSING', 'String'),
  \ javaapi#field(1,1,'ER_TYPED_ITERATOR_AXIS_NOT_IMPLEMENTED', 'String'),
  \ javaapi#field(1,1,'ER_ITERATOR_AXIS_NOT_IMPLEMENTED', 'String'),
  \ javaapi#field(1,1,'ER_ITERATOR_CLONE_NOT_SUPPORTED', 'String'),
  \ javaapi#field(1,1,'ER_UNKNOWN_AXIS_TYPE', 'String'),
  \ javaapi#field(1,1,'ER_AXIS_NOT_SUPPORTED', 'String'),
  \ javaapi#field(1,1,'ER_NO_DTMIDS_AVAIL', 'String'),
  \ javaapi#field(1,1,'ER_NOT_SUPPORTED', 'String'),
  \ javaapi#field(1,1,'ER_NODE_NON_NULL', 'String'),
  \ javaapi#field(1,1,'ER_COULD_NOT_RESOLVE_NODE', 'String'),
  \ javaapi#field(1,1,'ER_STARTPARSE_WHILE_PARSING', 'String'),
  \ javaapi#field(1,1,'ER_STARTPARSE_NEEDS_SAXPARSER', 'String'),
  \ javaapi#field(1,1,'ER_COULD_NOT_INIT_PARSER', 'String'),
  \ javaapi#field(1,1,'ER_EXCEPTION_CREATING_POOL', 'String'),
  ...
  \ javaapi#field(1,1,'ER_PARSER_IN_USE', 'String'),
  \ javaapi#field(1,1,'ER_CANNOT_CHANGE_WHILE_PARSING', 'String'),
  \ javaapi#field(1,1,'ER_SELF_CAUSATION_NOT_PERMITTED', 'String'),
  ...
  \ javaapi#field(1,1,'ER_METHOD_NOT_SUPPORTED', 'String'),
  \ javaapi#field(1,1,'ER_INCRSAXSRCFILTER_NOT_RESTARTABLE', 'String'),
  \ javaapi#field(1,1,'ER_XMLRDR_NOT_BEFORE_STARTPARSE', 'String'),
  \ javaapi#field(1,1,'ER_AXIS_TRAVERSER_NOT_SUPPORTED', 'String'),
  \ javaapi#field(1,1,'ER_ERRORHANDLER_CREATED_WITH_NULL_PRINTWRITER', 'String'),
  \ javaapi#field(1,1,'ER_SYSTEMID_UNKNOWN', 'String'),
  \ javaapi#field(1,1,'ER_LOCATION_UNKNOWN', 'String'),
  \ javaapi#field(1,1,'ER_PREFIX_MUST_RESOLVE', 'String'),
  \ javaapi#field(1,1,'ER_CREATEDOCUMENT_NOT_SUPPORTED', 'String'),
  \ javaapi#field(1,1,'ER_CHILD_HAS_NO_OWNER_DOCUMENT', 'String'),
  \ javaapi#field(1,1,'ER_CHILD_HAS_NO_OWNER_DOCUMENT_ELEMENT', 'String'),
  \ javaapi#field(1,1,'ER_CANT_OUTPUT_TEXT_BEFORE_DOC', 'String'),
  \ javaapi#field(1,1,'ER_CANT_HAVE_MORE_THAN_ONE_ROOT', 'String'),
  \ javaapi#field(1,1,'ER_ARG_LOCALNAME_NULL', 'String'),
  \ javaapi#field(1,1,'ER_ARG_LOCALNAME_INVALID', 'String'),
  \ javaapi#field(1,1,'ER_ARG_PREFIX_INVALID', 'String'),
  \ javaapi#field(1,1,'ER_NAME_CANT_START_WITH_COLON', 'String'),
...
call javaapi#class('XMLErrorResources_en', 'XMLErrorResources', [
  \ javaapi#method(0,1,'XMLErrorResources_en(', ')', ''),
  \ ])
...
call javaapi#class('XMLErrorResources_zh_HK', 'XMLErrorResources_zh_TW', [
  \ javaapi#method(0,1,'XMLErrorResources_zh_HK(', ')', ''),
  \ ])
...
call javaapi#class('XMLMessages', '', [
  ...
  \ javaapi#field(1,0,'BAD_CODE', 'String'),
  \ javaapi#field(1,0,'FORMAT_FAILED', 'String'),
  \ javaapi#method(0,1,'XMLMessages(', ')', ''),
  \ javaapi#method(0,1,'setLocale(', 'Locale)', 'void'),
  \ javaapi#method(0,1,'getLocale(', ')', 'Locale'),
  \ javaapi#method(1,1,'createXMLMessage(', 'String, Object[])', 'String'),
  \ javaapi#method(1,1,'createMsg(', 'ListResourceBundle, String, Object[])', 'String'),
  \ javaapi#method(1,1,'loadResourceBundle(', 'String) throws MissingResourceException', 'ListResourceBundle'),
  \ javaapi#method(1,0,'getResourceSuffix(', 'Locale)', 'String'),
  \ ])
