...
call javaapi#class('PKCS10Attributes', 'DerEncoder', [
  ...
  \ javaapi#method(0,1,'getElements(', ')', 'PKCS10Attribute>'),
  \ javaapi#method(0,1,'getAttributes(', ')', 'PKCS10Attribute>'),
  \ javaapi#method(0,1,'equals(', 'Object)', 'boolean'),
  \ javaapi#method(0,1,'hashCode(', ')', 'int'),
  \ javaapi#method(0,1,'toString(', ')', 'String'),
  \ ])
...
call javaapi#class('SignerInfo', 'DerEncoder', [
  ...
  \ javaapi#method(0,1,'getCertificateChain(', 'PKCS7) throws IOException', 'X509Certificate>'),
  \ javaapi#method(0,1,'getVersion(', ')', 'BigInteger'),
