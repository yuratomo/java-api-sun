...
call javaapi#class('Compile', '', [
  \ javaapi#method(0,'Compile(', ')', 'public'),
  \ javaapi#method(1,'printUsage(', ')', 'void'),
...
call javaapi#class('Transform', '', [
  \ javaapi#method(0,'Transform(', 'String, String, boolean, boolean, int)', 'public'),
  \ javaapi#method(0,'getFileName(', ')', 'String'),
  \ javaapi#method(0,'getClassName(', ')', 'String'),
  \ javaapi#method(0,'setParameters(', 'Vector)', 'void'),
  \ javaapi#method(1,'printUsage(', ')', 'void'),
  \ javaapi#method(1,'main(', 'String[])', 'void'),
  \ ])
