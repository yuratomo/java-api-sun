...
call javaapi#interface('DisplayChangedListener', '', [
...
call javaapi#class('Win32GraphicsEnvironment', '', [
...
call javaapi#class('LCDContrastKey', '', [
...
call javaapi#class('Win32GraphicsConfig', '', [
...
call javaapi#class('Win32GraphicsDevice', '', [
...
call javaapi#class('HeadlessToolkit', '', [
...
call javaapi#class('EmbeddedFrame', '', [
...
call javaapi#class('AWTSecurityManager', '', [
...
call javaapi#class('CausedFocusEvent', '', [
...
call javaapi#class('CustomCursor', '', [
...
call javaapi#class('NullEmbeddedFramePeer', '', [
  \ javaapi#method(0,'setTitle(', 'String)', 'void'),
  \ javaapi#method(0,'setIconImage(', 'Image)', 'void'),
...
call javaapi#class('FocusingTextField', '', [
...
call javaapi#class('FontProperties', '', [
  \ javaapi#method(0,'put(', 'Object, Object)', 'Object'),
  \ ])
...
call javaapi#class('ModalityEvent', '', [
...
call javaapi#class('OrientableFlowLayout', '', [
...
call javaapi#class('Win32ColorModel24', '', [
...
call javaapi#class('Win32FontManager', '', [
...
call javaapi#class('Win32FSWindowAdapter', '', [
