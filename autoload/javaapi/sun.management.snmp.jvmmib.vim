...
call javaapi#class('JVM_MANAGEMENT_MIB', '', [
  ...
  \ javaapi#method(0,'populate(', 'MBeanServer, ObjectName) throws Exception', 'void'),
...
call javaapi#class('JvmClassLoadingMeta', '', [
  ...
  \ javaapi#method(0,'skipVariable(', 'long, Object, int)', 'boolean'),
  ...
  \ javaapi#method(0,'registerTableNodes(', 'SnmpMib, MBeanServer)', 'void'),
  \ ])
...
call javaapi#class('JvmMemGCTableMeta', '', [
  ...
  \ javaapi#method(0,'registerEntryNode(', 'SnmpMib, MBeanServer)', 'void'),
  \ javaapi#method(0,'addEntry(', 'SnmpOid, ObjectName, Object) throws SnmpStatusException', 'void'),
  \ javaapi#method(0,'get(', 'SnmpMibSubRequest, SnmpOid, int) throws SnmpStatusException', 'void'),
  \ javaapi#method(0,'set(', 'SnmpMibSubRequest, SnmpOid, int) throws SnmpStatusException', 'void'),
  \ javaapi#method(0,'check(', 'SnmpMibSubRequest, SnmpOid, int) throws SnmpStatusException', 'void'),
  \ javaapi#method(0,'validateVarEntryId(', 'SnmpOid, long, Object) throws SnmpStatusException', 'void'),
  \ javaapi#method(0,'isReadableEntryId(', 'SnmpOid, long, Object) throws SnmpStatusException', 'boolean'),
  \ javaapi#method(0,'getNextVarEntryId(', 'SnmpOid, long, Object) throws SnmpStatusException', 'long'),
  \ javaapi#method(0,'skipEntryVariable(', 'SnmpOid, long, Object, int)', 'boolean'),
  \ ])
