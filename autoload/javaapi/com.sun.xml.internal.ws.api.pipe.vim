...
call javaapi#class('Stubs', '', [
  \ javaapi#method(1,1,'createSAAJDispatch(', 'QName, WSService, WSBinding, Mode, Tube, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createSAAJDispatch(', 'WSPortInfo, WSBinding, Mode, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createDataSourceDispatch(', 'QName, WSService, WSBinding, Mode, Tube, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createDataSourceDispatch(', 'WSPortInfo, WSBinding, Mode, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createSourceDispatch(', 'QName, WSService, WSBinding, Mode, Tube, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createSourceDispatch(', 'WSPortInfo, WSBinding, Mode, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createDispatch(', 'QName, WSService, WSBinding, Class<T>, Mode, Tube, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createDispatch(', 'WSPortInfo, WSService, WSBinding, Class<T>, Mode, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createJAXBDispatch(', 'QName, WSService, WSBinding, JAXBContext, Mode, Tube, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createJAXBDispatch(', 'WSPortInfo, WSBinding, JAXBContext, Mode, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createMessageDispatch(', 'QName, WSService, WSBinding, Tube, WSEndpointReference)', 'Dispatch'),
  \ javaapi#method(1,1,'createMessageDispatch(', 'WSPortInfo, WSBinding, WSEndpointReference)', 'Dispatch'),
