...
call javaapi#class('ProviderList', '', [
  ...
  \ javaapi#method(0,1,'providers(', ')', 'Provider>'),
  ...
  \ javaapi#method(0,1,'getServices(', 'String, String)', 'Service>'),
  \ javaapi#method(0,1,'getServices(', 'String, List<String>)', 'Service>'),
  \ javaapi#method(0,1,'getServices(', 'List<ServiceId>)', 'Service>'),
  \ ])
...
call javaapi#class('GetInstance', '', [
  ...
  \ javaapi#method(1,1,'getServices(', 'String, String)', 'Service>'),
  \ javaapi#method(1,1,'getServices(', 'String, List<String>)', 'Service>'),
  \ javaapi#method(1,1,'getServices(', 'List<ServiceId>)', 'Service>'),
